...
const database_migrations_service_1 = require("./database-migrations.service");
...
exports.MigrationsModule = MigrationsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [database_migrations_service_1.DatabaseMigrationService],
        exports: [database_migrations_service_1.DatabaseMigrationService],
    })
], MigrationsModule);
